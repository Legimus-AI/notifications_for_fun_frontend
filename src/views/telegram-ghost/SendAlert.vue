<template>
  <div class="send-alert-page">
    ...
    <div class="content-card">
      <form @submit.prevent="handleSendAlert" class="alert-form">
        ...
        <div class="form-group">
          <label for="message">Alert Message (Optional)</label>
          <textarea
            id="message"
            v-model="formData.message"
            class="form-control"
            rows="4"
            placeholder="Optional message with the alert..."
          ></textarea>
        </div>

        <div class="form-group">
          <label for="soundFile">Sound File (Optional)</label>
          <input
            id="soundFile"
          ...
          />
          <small class="form-text">Leave empty to use default alert sound</small>
        </div>
        ...
        <div class="form-group">
          ...
          <input
            ...
            max="60"
          />
          <small class="form-text">Alert duration in seconds (1-60)</small>
        </div>
        ...
        <div class="form-actions">
          ...
          >
            <font-awesome-icon
              :icon="isSending ? ['fas', 'spinner'] : ['fas', 'bell']"
...
const handleSendAlert = async () => {
  ...
  try {
    await store.sendAlert(
      ...
      formData.value.soundFile || undefined,
